...
namespace FHE.src.clouds
{
    ...
    public partial class FourierTransformService : Form
    {
        ...
        public FourierTransformService(FourierTransformApplication client, SEALContext context, PublicKey publicKey, int maxMultiplyCount, double scale, Model model, bool minimalLog)
        {
            InitializeComponent();
            this.client = client;
